...
Download `adb_mscu7c80bnmia_v30209.exe` from release `v33476` and run the installer.
...
- Module updates are delivered through new GitHub release tags; pin `v33476` for pilot groups.
